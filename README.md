...
*All 3D models should align properly with the KiCad and FreeCad coordinate systems. It wasn't the case with the previous version. The problem is now solved.*
